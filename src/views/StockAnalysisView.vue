    ...
    <div v-else-if="selectedStockId && stockAnalysisData" class="stock-details">
      ...
      <div class="profit-summary">
        <div class="summary-card">
          ...
          <div
            class="percentage"
            :class="{ positive: profitPercentage > 0, negative: profitPercentage < 0 }"
          >
          ...
          >
            ...
            <div class="transaction-body">
              ...
              <div
                ...
                class="transaction-profit"
                :class="{ positive: transaction.profit > 0, negative: transaction.profit < 0 }"
              >
      ...
      <div class="cost-analysis">
        ...
        <div class="cost-info">
          ...
          <div v-if="isHolding" class="cost-item">
            ...
            <span
              class="value"
              :class="{ positive: currentPrice > avgCost, negative: currentPrice < avgCost }"
            >
          ...
          <div v-if="isHolding" class="cost-item">
            ...
            <span
              class="value"
              :class="{ positive: unrealizedProfit > 0, negative: unrealizedProfit < 0 }"
            >
...
const formatTransactions = () => {
  ...
  // 按照日期倒序排列
  transactions.value = [...stockAnalysisData.value.transactions].sort(
    (a: any, b: any) =>
...
const buildTransactionsFromOrders = (orders: any[]) => {
  return orders.map((order, index) => ({
    ...
    transactionDate: order.created_time
...
const buildStockAnalysisData = (stockId: string, holding: any, orders: any[], history: any[]) => {
  ...
  if (history.length > 0) {
    ...
    currentPrice =
      holding.current_price || holding.avg_cost * (1 + (holding.profit_rate || 0) / 100)
  }
...
// 更新到指定日期的持仓情况
const updateHoldingUpToDate = (
  orders: any[],
  date: string,
  timestamp: string,
  callback: (quantity: number, amount: number) => void
) => {
  let quantity = 0
  let amount = 0
