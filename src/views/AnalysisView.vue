    ...
    returnChartInstance = new Chart(returnChart.value, {
      ...
      data: {
        ...
        datasets: [{
          ...
          backgroundColor: returnData[returnData.length - 1] >= 0 ? 'rgba(16, 185, 129, 0.1)' : 'rgba(239, 68, 68, 0.1)',
          fill: true,
          tension: 0.4
        }]
      },
